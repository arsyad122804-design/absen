            ...
            {filteredData.map((row) => (
              <tr key={row.id}>
                ...
                <td style={{position: 'relative'}}>
                  ...
                  {activeMenuId === row.id && (
                    <div className="action-dropdown" onClick={e => e.stopPropagation()} style={{ position: 'absolute', right: '20px', top: '35px', background: 'white', border: '1px solid #E2E8F0', borderRadius: '8px', boxShadow: '0 10px 15px -3px rgba(0,0,0,0.1)', zIndex: 9999, display: 'flex', flexDirection: 'column', padding: '8px', minWidth: '160px' }}>
